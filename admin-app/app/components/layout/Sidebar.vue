...
const navigationItems = [
  ...
  // Onboarding Section
  { label: 'Organizations', path: '/organizations', icon: 'M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z', section: true },
  ...
  // Operations Section
  { label: 'Operations', path: '/operations/routes', icon: 'M13 10V3L4 14h7v7l9-11h-7z', section: true },
  { label: 'Operation Routes', path: '/operations/routes', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  // Transactions Section
  { label: 'Transactions', path: '/transactions', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V4m0 4v8m-6-9c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M6 9V5m0 4v4', section: true },
    ...
    <nav class="flex-1 p-4 space-y-2">
      <button
        ...
        :class="`
          ...
          ${open ? '' : 'justify-center'}
          ${item.section ? 'mt-4 mb-2 font-semibold text-xs uppercase' : ''}
        `"
      >
