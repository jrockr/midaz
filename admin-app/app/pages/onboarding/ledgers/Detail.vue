        ...
        <Card class="p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p class="text-sm text-gray-600 mt-1">View ledger assets</p>
            </button>
            <button
              @click="router.push('/portfolios')"
              class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left"
            >
              <h3 class="font-medium text-gray-900">Portfolios</h3>
              <p class="text-sm text-gray-600 mt-1">View ledger portfolios</p>
            </button>
            <button
              @click="router.push('/segments')"
              class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left"
            >
              <h3 class="font-medium text-gray-900">Segments</h3>
              <p class="text-sm text-gray-600 mt-1">View ledger segments</p>
            </button>
          </div>
        </Card>
      </div>
